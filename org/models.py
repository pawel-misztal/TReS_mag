...
class Net(nn.Module):
	def __init__(self,cfg,device):
		...
		if cfg.network =='resnet50':
			from org.resnet_modify  import resnet50 as resnet_modifyresnet
			dim_modelt = 3840
			modelpretrain = models.resnet50(pretrained=True)

		elif cfg.network =='resnet34':
			from org.resnet_modify  import resnet34 as resnet_modifyresnet
			...
			from org.resnet_modify  import resnet18 as resnet_modifyresnet
